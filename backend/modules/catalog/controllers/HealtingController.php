...
use backend\modules\catalog\models\search\HealtingSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use Yii;

class HealtingController extends Controller
{
    ...
    {
        $searchModel = new HealtingSearch();
    ...
    {
        if (($model = Healting::findOne(['id' => $id])) !== null) {
            return $model;
        }
