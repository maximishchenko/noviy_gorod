                            ...
                            <?php if(isset($model->image) && !empty($model->image)): ?>
                                <div class="row">
                                    <?= SingleImagePreviewWidget::widget([
                                        'id' => $model->id,
                                        'filePath' => $model->getUrl(Commercial::UPLOAD_PATH, $model->image),
                                        'url' => 'delete-image',
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if(isset($model->layout_image) && !empty($model->layout_image)): ?>
                                <div class="row">
                                    <?= SingleImagePreviewWidget::widget([
                                        'id' => $model->id,
                                        'filePath' => $model->getUrl(Commercial::UPLOAD_PATH, $model->layout_image),
...
<?= $this->render('//layouts/forms/_buttons', ['formId' => 'commercial-form']); ?>