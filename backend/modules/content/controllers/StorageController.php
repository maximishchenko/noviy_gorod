...
use backend\modules\content\models\search\StorageSearch;
use Yii;
...
class StorageController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $file = $model->getPath(Storage::UPLOAD_PATH, $model->image);
    ...
    {
        $model = $this->findModel($id);
        $file = $model->getPath(Storage::UPLOAD_PATH, $model->layout_image);
        $model->removeSingleFileIfExist($file);
    ...
    public function actionSetDefaultItem($id)
    {
        ...
        $configManager->setItemValues(['contentStorageStage' => $id]);
    ...
    {
        $configManager = Yii::$app->get('configManager');
        $configManager->setItemValues(['contentStorageStage' => ""]);
        $configManager->saveValues();
